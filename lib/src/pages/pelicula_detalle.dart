...
import 'package:foodnews/src/models/actores_model.dart';
...
class PeliculaDetalle extends StatelessWidget {
  ...
  Widget _crarCasting(Pelicula pelicula) {
  ...
  Widget _tarjetActor(Actor actor) {
    return Container(
      child: Column(
        children: [
          ClipRRect(
